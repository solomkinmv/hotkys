  ...
  return (
    <div>
      <Space direction="vertical">
        ...
        <Text>Create PR with shortcuts in <Text code>shortcuts-data</Text> on <Link href="https://github.com/solomkinmv/shortcuts-disco/tree/main/shortcuts-disco-site/shortcuts-data"
