      ...
      <Space direction="vertical">
        ...
        <Image.PreviewGroup>
          <Space direction="horizontal" wrap={true}>
            ...
            <Image alt="Application specific shortcuts in Raycast extension" width={380}
                   src="media/shortcuts-search-3.png" />
        ...
        <a title="Install shortcuts-search Raycast Extension"
          ...
          <Image
            ...
            alt="Install Shortcuts Disco Raycas extension" style={{ height: 64, width: 256 }}
          />
        </a>
      </Space>
    </div>
