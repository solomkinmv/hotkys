 ...
 * Each keymap consist of title, optional platforms array, and sections.
 * Platforms array can be specified to indicate which operating systems the keymap is for.
